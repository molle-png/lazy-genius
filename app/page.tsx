...
import {
  ...
  CheckCircle2, Camera, ArrowRight, Eye, EyeOff, Globe
} from "lucide-react";
...
const STRINGS = {
  en: {
    ...
    flag: "🇬🇧",
    welcome: "Welcome,",
    signinSub: "Sign in to your client communication system.",
    email: "Email",
    password: "Password",
    signin: "Sign in",
    enterCreds: "Please enter your email and password",
    builtFor: "Built for",
    nav: { home: "Home", generate: "Generate update", schedule: "Schedule", projects: "Projects", resources: "Resources" },
    signout: "Sign out",
    hi: "Hi",
    homeSub: "Three projects running. All updates scheduled. Nothing on your plate.",
    nextAutoSend: "Next auto-send",
    fridayBig: "Friday 5:00 PM",
    nextSendDesc: "All 3 client updates will be sent automatically. Just send your photos this week.",
    generateNow: "Generate update now",
    viewSchedule: "View schedule",
    days: "days", hrs: "hrs", min: "min", sec: "sec",
    activeProjects: "Active projects",
    updatesMonth: "Updates this month",
    onTime: "On-time rate",
    photosArchived: "Photos archived",
    allProjects: "All projects",
    recentActivity: "Recent activity",
    weekUpdateSent: "Week {n} update sent to",
    photosUploaded: "{n} photos uploaded",
    next: "Next",
    photos: "photos",
    week: "Week",
    complete: "complete",
    ...
    genKicker: "Generator",
    genTitle1: "Build a",
    genTitle2: "weekly update",
    genSub: "Pick a project, drop in photos, write a quick note. The message formats itself.",
    step1: "1. Select project",
    chooseProject: "— Choose a project —",
    weekNumber: "Week number",
    resetTo: "Reset to week",
    step2: "2. Upload photos",
    clickOrDrop: "Click or drop images",
    maxReached: "Maximum reached",
    upTo3: "JPG, PNG · up to 3 photos",
    step3: "3. What happened this week",
    notePlaceholder: "Foundation pour completed Monday. Wall framing finished Thursday. Plumbing rough-in started Friday.",
    chars: "characters",
    step4: "4. What's coming next week",
    nextPlaceholder: "Electrical rough-in. Begin tile installation in master bath.",
    waPreview: "WhatsApp preview",
    copyMessage: "Copy message",
    copied: "Copied",
    selectProjectFirst: "Please select a project first",
    writeNoteFirst: "Please write a weekly note",
    copiedToast: "Copied to clipboard — open WhatsApp and paste",
    max3: "Maximum 3 photos",
    addedSkipped: "Added {a}, skipped {s}",
    needBoth: "Select a project and write a note to enable copying.",
    needProject: "Select a project to continue.",
    needNote: "Write a weekly note to continue.",
    msgThisWeek: "This week:",
    msgNextWeek: "Next week:",
    msgAddNote: "[Add your weekly progress note]",
    msgAddPlan: "[Add next week's plan]",
    msgAttached: "attached",
    msgQuestions: "Questions? Reply here anytime.",
    // Schedule
    schedKicker: "Schedule",
    schedTitle1: "Every Friday at",
    schedTitle2: "5:00 PM",
    schedSub: "All client updates go out automatically. You only send the photos.",
    upcoming: "Upcoming",
    sent: "Sent",
    scheduled: "Scheduled",
    sentBadge: "✓ Sent",
    ...
    // Resources
    resKicker: "Resources",
    resTitle1: "Everything",
    resTitle2: "you get",
    resSub: "Part of your pilot. Yours to keep — full ownership, no lock-in.",
    pilotBadge: "The pilot",
    pilotTitle: "Automatic weekly project update",
    pilotSub: "for your construction clients — sent on WhatsApp",
    pilot1: "Every Friday, your client gets a clean update on their project.",
    pilot2: "Photos from the site, what work was done, what comes next week.",
    pilot3: "You only send me a few photos on WhatsApp. The rest is automatic.",
    pilot4: "Your client feels informed. You look professional. No more questions.",
    whatYouGet: "What you get",
    sysTag: "System", sysTitle: "A working system", sysDesc: "Sends weekly updates to all your clients — automatically, every Friday.", sysFooter: "Live · running now",
    guideTag: "Guide", guideTitle: "A simple guide", guideDesc: "Step-by-step instructions so you and your team can use the system without me.", guideFooter: "Open guide",
    videoTag: "Video", videoTitle: "Walkthrough video", videoDesc: "A short video walkthrough in easy English. Watch on your phone whenever you need.", videoFooter: "Watch · 4:32",
    supportTag: "Support", supportTitle: "My time and support", supportDesc: "Reach me directly on WhatsApp during the pilot. Questions, fixes, adjustments — all included.", supportFooter: "Message Fredrik on WhatsApp",
    quote: '{t.quote}',
    quoteSig: "Founder · Lazy Genius · WhatsApp +46 70 069 21 10",
  },
  id: {
    label: "Bahasa Indonesia",
    flag: "🇮🇩",
    welcome: "Selamat datang,",
    signinSub: "Masuk ke sistem komunikasi klien Anda.",
    email: "Email",
    password: "Kata sandi",
    signin: "Masuk",
    enterCreds: "Mohon masukkan email dan kata sandi Anda",
    builtFor: "Dibuat untuk",
    nav: { home: "Beranda", generate: "Buat update", schedule: "Jadwal", projects: "Proyek", resources: "Sumber daya" },
    signout: "Keluar",
    hi: "Halo",
    homeSub: "Tiga proyek berjalan. Semua update terjadwal. Tidak ada yang perlu Anda lakukan.",
    nextAutoSend: "Pengiriman otomatis berikutnya",
    fridayBig: "Jumat 17:00",
    nextSendDesc: "3 update klien akan dikirim otomatis. Cukup kirim foto Anda minggu ini.",
    generateNow: "Buat update sekarang",
    viewSchedule: "Lihat jadwal",
    days: "hari", hrs: "jam", min: "menit", sec: "detik",
    activeProjects: "Proyek aktif",
    updatesMonth: "Update bulan ini",
    onTime: "Tepat waktu",
    photosArchived: "Foto tersimpan",
    allProjects: "Semua proyek",
    recentActivity: "Aktivitas terbaru",
    weekUpdateSent: "Update minggu {n} dikirim ke",
    photosUploaded: "{n} foto diunggah",
    next: "Berikutnya",
    photos: "foto",
    week: "Minggu",
    complete: "selesai",
    ...
    genKicker: "Generator",
    genTitle1: "Buat",
    genTitle2: "update mingguan",
    genSub: "Pilih proyek, masukkan foto, tulis catatan singkat. Pesan akan diformat sendiri.",
    step1: "1. Pilih proyek",
    chooseProject: "— Pilih proyek —",
    weekNumber: "Nomor minggu",
    resetTo: "Reset ke minggu",
    step2: "2. Unggah foto",
    clickOrDrop: "Klik atau seret gambar",
    maxReached: "Maksimum tercapai",
    upTo3: "JPG, PNG · hingga 3 foto",
    step3: "3. Apa yang terjadi minggu ini",
    notePlaceholder: "Pengecoran fondasi selesai hari Senin. Rangka dinding selesai hari Kamis. Pipa air mulai hari Jumat.",
    chars: "karakter",
    step4: "4. Rencana minggu depan",
    nextPlaceholder: "Pemasangan listrik. Mulai pasang keramik di kamar mandi utama.",
    waPreview: "Pratinjau WhatsApp",
    copyMessage: "Salin pesan",
    copied: "Tersalin",
    selectProjectFirst: "Pilih proyek terlebih dahulu",
    writeNoteFirst: "Tulis catatan mingguan",
    copiedToast: "Tersalin — buka WhatsApp dan tempel",
    max3: "Maksimum 3 foto",
    addedSkipped: "Ditambah {a}, dilewati {s}",
    needBoth: "Pilih proyek dan tulis catatan untuk mengaktifkan tombol salin.",
    needProject: "Pilih proyek untuk melanjutkan.",
    needNote: "Tulis catatan mingguan untuk melanjutkan.",
    msgThisWeek: "Minggu ini:",
    msgNextWeek: "Minggu depan:",
    msgAddNote: "[Tambahkan catatan progres mingguan]",
    msgAddPlan: "[Tambahkan rencana minggu depan]",
    msgAttached: "terlampir",
    msgQuestions: "Ada pertanyaan? Balas pesan ini kapan saja.",
    // Schedule
    schedKicker: "Jadwal",
    schedTitle1: "Setiap Jumat pukul",
    schedTitle2: "17:00",
    schedSub: "Semua update klien dikirim otomatis. Anda cukup kirim fotonya.",
    ...
    projKicker: "Proyek",
    projTitle1: "Tiga",
    projTitle2: "lokasi aktif",
    client: "Klien",
    currentWeek: "Minggu saat ini",
    phase: "Fase",
    lastUpdate: "Update terakhir",
    nextSend: "Pengiriman berikutnya",
    photoArchive: "Arsip foto",
    // Resources
    resKicker: "Sumber daya",
    resTitle1: "Semua yang",
    resTitle2: "Anda dapatkan",
    resSub: "Bagian dari pilot Anda. Milik Anda — kepemilikan penuh, tanpa terikat kontrak.",
    pilotBadge: "Pilot",
    pilotTitle: "Update proyek mingguan otomatis",
    pilotSub: "untuk klien konstruksi Anda — dikirim via WhatsApp",
    pilot1: "Setiap Jumat, klien Anda menerima update yang rapi tentang proyek mereka.",
    pilot2: "Foto dari lokasi, pekerjaan yang selesai, dan rencana minggu depan.",
    pilot3: "Anda cukup kirim beberapa foto di WhatsApp. Sisanya otomatis.",
    pilot4: "Klien merasa diinformasikan. Anda terlihat profesional. Tanpa pertanyaan lagi.",
    whatYouGet: "Yang Anda dapatkan",
    sysTag: "Sistem", sysTitle: "Sistem yang berjalan", sysDesc: "Mengirim update mingguan ke semua klien Anda — otomatis, setiap Jumat.", sysFooter: "Aktif · berjalan sekarang",
    guideTag: "Panduan", guideTitle: "Panduan sederhana", guideDesc: "Petunjuk langkah demi langkah agar Anda dan tim bisa pakai sendiri.", guideFooter: "Buka panduan",
    videoTag: "Video", videoTitle: "Video panduan", videoDesc: "Video singkat dalam bahasa sederhana. Tonton di HP Anda kapan saja.", videoFooter: "Tonton · 4:32",
    supportTag: "Dukungan", supportTitle: "Waktu dan dukungan saya", supportDesc: "Hubungi saya langsung di WhatsApp selama pilot. Pertanyaan, perbaikan, penyesuaian — semua termasuk.", supportFooter: "Pesan Fredrik di WhatsApp",
    quote: '"Pak Budi, ini milik Bapak. Kepemilikan penuh, tanpa terikat. Kalau berhasil, kita lanjutkan. Kalau tidak, kita berhenti. Itu adil untuk kita berdua."',
    quoteSig: "Founder · Lazy Genius · WhatsApp +46 70 069 21 10",
  },
};

const I18nContext = React.createContext({ t: STRINGS.en, lang: "en", setLang: () => {} });
      ...
      <div className="w-full max-w-md relative fade-up">
        ...
        <div className="rounded-2xl p-7 sm:p-8 border"
          ...
          <h1 style={{ fontFamily: SERIF_STACK }} className="text-3xl sm:text-[34px] leading-[1.1] mb-1.5">
            {t.welcome} <span style={{ fontStyle: "italic", color: BRAND.purple }}>Pak Budi</span>
          </h1>
        ...
        <p className="text-center text-xs mt-6" style={{ color: BRAND.muted }}>
          {t.builtFor} <span className="font-medium" style={{ color: BRAND.text }}>PT. Karya Cipta Mandiri</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative" ref={ref}>
      <button onClick={() => setOpen((v) => !v)}
        ...
        onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = BRAND.surface)}>
        <span style={{ fontSize: 13 }}>{current.flag}</span>
        <span>{current.label}</span>
        <span style={{ fontSize: 9, color: BRAND.muted }}>▾</span>
      </button>
      {open && (
        <div className="absolute right-0 mt-1.5 rounded-lg border shadow-lg overflow-hidden z-50 min-w-[180px]"
          ...
          {opts.map((o) => (
            <button key={o.code} onClick={() => { setLang(o.code); setOpen(false); }}
              ...
              style={{ backgroundColor: o.code === lang ? BRAND.purpleSoft : BRAND.surface, color: o.code === lang ? BRAND.purple : BRAND.text }}
              onMouseEnter={(e) => o.code !== lang && (e.currentTarget.style.backgroundColor = "#F5F5F4")}
              onMouseLeave={(e) => o.code !== lang && (e.currentTarget.style.backgroundColor = BRAND.surface)}>
              <span>{o.flag}</span>
              <span className="flex-1">{o.label}</span>
              {o.code === lang && <Check size={14} />}
            </button>
          ))}
        </div>
      )}
...
function Shell({ view, setView, onLogout }) {
  ...
  const nav = [
    ...
    { id: "generate", label: t.nav.generate, icon: Send },
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="hidden md:flex flex-col w-[240px] border-r flex-shrink-0" style={{ borderColor: BRAND.border, backgroundColor: BRAND.surface }}>
        ...
        <div className="px-3 py-3 border-b flex" style={{ borderColor: BRAND.border }}>
          <LanguageSwitcher />
        </div>
        ...
        <div className="p-3 border-t" style={{ borderColor: BRAND.border }}>
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg">
            ...
            <button onClick={onLogout} title={t.signout} style={{ color: BRAND.muted }}><LogOut size={16} /></button>
          </div>
        </div>
      </aside>

      <div className="md:hidden fixed top-0 left-0 right-0 z-30 border-b flex items-center justify-between px-3 h-14 gap-2" style={{ borderColor: BRAND.border, backgroundColor: BRAND.surface }}>
        <div className="flex items-center gap-2 min-w-0"><PandaMark size={28} /><span className="font-bold tracking-tight truncate">Lazy Genius</span></div>
    ...
    <div className="space-y-8">
      <div>
        ...
        <h1 style={{ fontFamily: SERIF_STACK }} className="text-[32px] sm:text-[52px] leading-[1.05] tracking-tight">
          {t.hi} <span style={{ fontStyle: "italic", color: BRAND.purple }}>Pak Budi</span> 🌅
        </h1>
        ...
        <div className="relative z-10 grid sm:grid-cols-[1fr_auto] gap-6 items-end">
          <div>
            <div className="flex items-center gap-2 text-xs uppercase tracking-widest mb-3" style={{ color: "rgba(255,255,255,0.75)" }}>
              <span className="w-1.5 h-1.5 rounded-full bg-green-400 live-dot" /> {t.nextAutoSend}
            </div>
            <div style={{ fontFamily: SERIF_STACK }} className="text-[32px] sm:text-[56px] leading-[1.05] mb-2">{t.fridayBig}</div>
            <p className="text-sm sm:text-base opacity-90">{t.nextSendDesc}</p>
          </div>
          <div className="grid grid-cols-4 gap-3 sm:gap-4">
            {[{ label: t.days, v: countdown.d }, { label: t.hrs, v: countdown.h }, { label: t.min, v: countdown.m }, { label: t.sec, v: countdown.s }].map((b) => (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        <Stat label={t.activeProjects} value="3" icon={FolderKanban} />
        <Stat label={t.updatesMonth} value="12" icon={Send} accent={BRAND.purple} />
        <Stat label={t.onTime} value="100%" icon={CheckCircle2} accent={BRAND.success} />
        <Stat label={t.photosArchived} value="263" icon={Camera} accent={BRAND.orange} />
      </div>

      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <SectionHeader title={t.nav.projects} action={{ label: t.allProjects, onClick: () => setView("projects") }} />
              ...
              <div key={a.id} className={`p-4 flex gap-3 items-start ${i !== ACTIVITY.length - 1 ? "border-b" : ""}`} style={{ borderColor: BRAND.border }}>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm leading-snug">
                    {a.type === "sent"
                      ? <>{t.weekUpdateSent.replace("{n}", a.week)} <span className="font-medium">{a.client}</span></>
                      : <><span className="font-medium">{t.photosUploaded.replace("{n}", a.count)}</span></>}
                  </p>
  ...
  return (
    <div className="rounded-xl border p-4 sm:p-5 hover:shadow-sm transition" style={{ borderColor: BRAND.border, backgroundColor: BRAND.surface }}>
      <div className="flex items-center justify-between gap-3 mb-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="text-xs truncate" style={{ color: BRAND.muted }}>{p.client} · {t.week} {p.week} · {p.phase}</div>
          </div>
        </div>
        <div className="text-right flex-shrink-0">
          <div className="text-sm font-semibold tabular-nums">{p.progress}%</div>
          <div className="text-[10px] uppercase tracking-wider" style={{ color: BRAND.muted }}>{t.complete}</div>
        </div>
      </div>
      ...
      <div className="mt-3 flex items-center justify-between text-xs" style={{ color: BRAND.muted }}>
        <span className="inline-flex items-center gap-1.5"><Clock size={12} /> {t.next}: {p.nextSend}</span>
        <span>{p.photoCount} {t.photos}</span>
      </div>
    </div>
  );
}
...
function GenerateView() {
  ...
  const message = useMemo(() => {
    ...
    const projectUpdate = t === STRINGS.id ? "Update Proyek" : "Project Update";
    return `Hi ${clientName} 👋

*${projectUpdate} — ${t.week} ${week}*
📍 ${projectName}
...
📅 ${t.msgNextWeek}
${nextSteps || t.msgAddPlan}

📸 ${photos.length} ${t.photos} ${t.msgAttached}

${t.msgQuestions}
— PT. Karya Cipta Mandiri`;
  }, [project, week, note, nextSteps, photos.length, t]);
  ...
  function handleFiles(files) {
    ...
    if (remaining <= 0) return showToast(t.max3, "error");
    const accepted = incoming.slice(0, remaining).map((f) => ({
      id: `${f.name}-${f.size}-${Date.now()}-${Math.random()}`,
      url: URL.createObjectURL(f), name: f.name,
    }));
    setPhotos((prev) => [...prev, ...accepted]);
    if (incoming.length > remaining) showToast(t.addedSkipped.replace("{a}", remaining).replace("{s}", incoming.length - remaining), "error");
  }
  ...
  function handleCopy() {
    if (!projectId) return showToast(t.selectProjectFirst, "error");
    if (!note.trim()) return showToast(t.writeNoteFirst, "error");
  ...
  return (
    <div className="space-y-7">
      <header>
        <p className="text-sm mb-1.5" style={{ color: BRAND.muted }}>{t.genKicker}</p>
        <h1 style={{ fontFamily: SERIF_STACK }} className="text-[28px] sm:text-[44px] leading-[1.05] tracking-tight">
          {t.genTitle1} <span style={{ fontStyle: "italic", color: BRAND.purple }}>{t.genTitle2}</span>
        </h1>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="space-y-4">
          <Card title={t.step1}>
            ...
            <div className="mt-4">
              <label className="block text-[13px] font-medium mb-2">{t.weekNumber}</label>
              <div className="flex items-center gap-2">
                ...
                {project && week !== project.week && (
                  <button onClick={() => setWeek(project.week)} className="text-xs underline ml-1" style={{ color: BRAND.purple }}>{t.resetTo} {project.week}</button>
                )}
              </div>
            </div>
          </Card>

          <Card title={t.step2} subtitle={`${photos.length} / 3`}>
            <div onClick={() => photos.length < 3 && fileInputRef.current?.click()}
              ...
              <p className="text-sm font-medium">{photos.length >= 3 ? t.maxReached : t.clickOrDrop}</p>
              <p className="text-xs mt-1" style={{ color: BRAND.muted }}>{t.upTo3}</p>
          ...
          <Card title={t.step3}>
            <textarea value={note} onChange={(e) => setNote(e.target.value)}
              ...
              onFocus={(e) => (e.target.style.borderColor = BRAND.purple)}
              onBlur={(e) => (e.target.style.borderColor = BRAND.border)} />
            <div className="text-xs mt-1.5" style={{ color: BRAND.muted }}>{note.length} {t.chars}</div>
          </Card>
        ...
        <div className="lg:sticky lg:top-6 lg:self-start space-y-3">
          <div className="rounded-xl border overflow-hidden" style={{ borderColor: BRAND.border, backgroundColor: BRAND.surface }}>
            <div className="px-5 py-4 border-b flex items-center justify-between" style={{ borderColor: BRAND.border }}>
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-semibold tracking-tight">{t.waPreview}</h2>
              </div>
          ...
          {!canCopy && (
            <div className="flex items-start gap-2 text-sm rounded-lg px-3.5 py-2.5 border" style={{ backgroundColor: BRAND.orangeSoft, borderColor: "#FFCCBC", color: BRAND.text }}>
              ...
              <span>
                {!projectId && !note.trim() ? t.needBoth
                  : !projectId ? t.needProject
                  : t.needNote}
              </span>
            </div>
          )}
...
function ScheduleView() {
  ...
  return (
    <div className="space-y-7">
      <header>
        <p className="text-sm mb-1.5" style={{ color: BRAND.muted }}>{t.schedKicker}</p>
        <h1 style={{ fontFamily: SERIF_STACK }} className="text-[28px] sm:text-[44px] leading-[1.05] tracking-tight">
          {t.schedTitle1} <span style={{ fontStyle: "italic", color: BRAND.purple }}>{t.schedTitle2}</span>
        </h1>
        <p className="text-base mt-2 max-w-xl" style={{ color: BRAND.muted }}>
          {t.schedSub}
        </p>
    ...
    <div className="rounded-xl border p-4 sm:p-5" style={{ borderColor: BRAND.border, backgroundColor: BRAND.surface }}>
      <div className="flex items-center justify-between gap-3 mb-3">
        ...
        <span className="text-[11px] uppercase tracking-wider px-2.5 py-1 rounded-full font-semibold"
          ...
          {isSent ? t.sentBadge : t.scheduled}
        </span>
      </div>
...
function ProjectsView() {
  ...
  return (
    <div className="space-y-7">
      <header>
        <p className="text-sm mb-1.5" style={{ color: BRAND.muted }}>{t.projKicker}</p>
        <h1 style={{ fontFamily: SERIF_STACK }} className="text-[28px] sm:text-[44px] leading-[1.05] tracking-tight">
          {t.projTitle1} <span style={{ fontStyle: "italic", color: BRAND.purple }}>{t.projTitle2}</span>
        </h1>
      </header>
            ...
            <div className="p-5">
              <div className="flex items-start justify-between gap-3 mb-2">
                <div>
                  ...
                  <p className="text-sm" style={{ color: BRAND.muted }}>{t.client}: {p.client}</p>
                </div>
              ...
              <dl className="grid grid-cols-2 gap-y-2.5 gap-x-4 text-sm">
                <dt style={{ color: BRAND.muted }}>{t.currentWeek}</dt><dd className="font-medium">{t.week} {p.week}</dd>
                <dt style={{ color: BRAND.muted }}>{t.phase}</dt><dd className="font-medium">{p.phase}</dd>
                <dt style={{ color: BRAND.muted }}>{t.lastUpdate}</dt><dd className="font-medium">{p.lastSent}</dd>
                <dt style={{ color: BRAND.muted }}>{t.nextSend}</dt><dd className="font-medium" style={{ color: BRAND.purple }}>{p.nextSend}</dd>
                <dt style={{ color: BRAND.muted }}>{t.photoArchive}</dt><dd className="font-medium">{p.photoCount} {t.photos}</dd>
              </dl>
            </div>
          </div>
        ))}
...
function ResourcesView() {
  ...
  return (
    <div className="space-y-8">
      <header>
        <p className="text-sm mb-1.5" style={{ color: BRAND.muted }}>{t.resKicker}</p>
        <h1 style={{ fontFamily: SERIF_STACK }} className="text-[28px] sm:text-[44px] leading-[1.05] tracking-tight">
          {t.resTitle1} <span style={{ fontStyle: "italic", color: BRAND.purple }}>{t.resTitle2}</span>
        </h1>
      ...
      <div className="rounded-2xl p-5 sm:p-8 border relative overflow-hidden" style={{ borderColor: BRAND.border, backgroundColor: BRAND.surface }}>
        <div className="absolute top-4 right-4 text-[10px] uppercase tracking-widest font-bold px-2.5 py-1 rounded-full" style={{ backgroundColor: BRAND.purpleSoft, color: BRAND.purple }}>{t.pilotBadge}</div>
        ...
        <div className="grid sm:grid-cols-2 gap-3 mt-6 max-w-3xl">
          {[t.pilot1, t.pilot2, t.pilot3, t.pilot4].map((line, i) => (
      ...
      <div>
        <SectionHeader title={t.whatYouGet} />
        <div className="grid md:grid-cols-2 gap-4">
          <ResourceCard tag={t.sysTag} icon={Sparkles} title={t.sysTitle}
            description={t.sysDesc}
            footer={t.sysFooter} footerIcon="dot" />
          <ResourceCard tag={t.guideTag} icon={FileText} title={t.guideTitle}
            description={t.guideDesc}
            footer={t.guideFooter} cta />
          <ResourceCard tag={t.videoTag} icon={Play} title={t.videoTitle}
            description={t.videoDesc}
            footer={t.videoFooter} cta video />
          <ResourceCard tag={t.supportTag} icon={HelpCircle} title={t.supportTitle}
            description={t.supportDesc}
            footer={t.supportFooter} cta accent={BRAND.whatsapp} />
        </div>
      </div>
      ...
      <div className="rounded-2xl p-5 sm:p-8 border flex flex-col sm:flex-row gap-5 sm:items-center" style={{ borderColor: BRAND.border, backgroundColor: BRAND.purpleSoft }}>
        ...
        <div className="flex-1">
          ...
          <p className="text-sm mt-3" style={{ color: BRAND.muted }}>
            — <span className="font-medium" style={{ color: BRAND.text }}>Fredrik Lindström</span>, {t.quoteSig}
          </p>
        </div>
      </div>
    </div>
